...
<div className="flex flex-col justify-center items-center min-h-screen"  style={{ backgroundImage: 'url("/images/genisEkranArkaPlan.png")' , backgroundRepeat:"no-repeat", backgroundSize:"cover"  }}> 
  ...
  <div className=" flex flex-row justify-center items-center w-full pt-2 pb-10">
    <input value={searchTermCities} onChange={e => setSearchTermCities(e.target.value)} className="bg-cream opacity-60 focus:opacity-100 text-earthyBrown rounded-md h-12 w-1/2 lg:w-2/5  xl:w-1/3 outline-none xl:text-xl pl-3"></input>
  </div>

  <div className="grid grid-cols-1 2sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 m-1" >
